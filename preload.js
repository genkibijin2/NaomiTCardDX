...
document.getElementById("barChart").classList.add("selectedMode"); //start on bar chart
document.getElementById("barChart").addEventListener("mouseenter", () =>{
  helper.innerText = "Swap to bar chart mode";
});
document.getElementById("lineChart").addEventListener("mouseenter", () =>{
  helper.innerText = "Swap to line chart mode";
});
...
//Selection Event Listeners/Chart Types:
document.querySelectorAll(".chartDisplayButton").forEach(function(elem) {
  elem.addEventListener("click", function() {
    document.querySelectorAll(".chartDisplayButton").forEach(function(elem) {
      if(elem.classList.contains("selectedMode")){
       elem.classList.remove("selectedMode");
      }
    });
